...
<template>
    ...
    <v-card class="pa-2" width="1500" height="3000" outlined title>
      ...
      <v-row> <v-card-title>Address</v-card-title>
    <v-text-field color="white" hide-details v.length="25" single-line rounded="false" background-color="secondary" class="shrink" append-icon="mdi-pen"
        ...
        <v-row no-gutters>
          <v-col no-gutters cols="6" md="4" height="650" max-height="650">
            <v-card class="pa-2" height="475">
              ...
              ></v-img>
              <v-spacer> </v-spacer>
            <v-row>  <v-btn class="ma-2" color="primary" dark>
                Schedule Showing
    ...
    <v-text-field color="white" hide-details v.length="25" single-line rounded="false" background-color="secondary" class="shrink" append-icon="mdi-pen"
        value="(###)###-####"
      ></v-text-field> <v-spacer></v-spacer></v-row>
     <v-row> <v-btn class="ma-2" color="primary" dark to="/managelistings">
                Save Changes
